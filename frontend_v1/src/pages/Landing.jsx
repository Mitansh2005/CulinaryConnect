...
const highlights = [
  {
    ...
    value: "2.4x",
    detail: "Clearer cards, tighter screening, less inbox churn for recruiters.",
  },
  {
    label: "Curated culinary roles",
    value: "180+",
    detail: "Front-of-house, pastry, prep, executive, and seasonal kitchen openings.",
  },
  {
    label: "Verified hiring flow",
    value: "FSSAI",
    detail: "Recruiter onboarding is structured for real restaurant teams, not generic job boards.",
  },
];
...
const pillars = [
  {
    ...
    description: "Role signals, portfolio details, and hiring actions are tailored to culinary recruiting instead of generic resumes.",
  },
  {
    icon: Users,
    title: "One place for both sides",
    description: "Chefs can manage applications and identity, while restaurants can post openings and track applicants in the same system.",
  },
  {
    icon: ShieldCheck,
    title: "Operationally grounded",
    description: "Recruiter setup captures company details early so the marketplace feels credible from the first interaction.",
  },
];
...
export default function Landing() {
  ...
  return (
    <div className="shell-canvas overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1440px] flex-col px-4 pb-10 pt-5 sm:px-6 lg:px-10 lg:pb-14">
        ...
        <main className="grid flex-1 gap-8 py-8 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:py-10">
          <motion.section
            ...
            className="space-y-8"
          >
            <div className="inline-flex items-center gap-2 rounded-full border border-ember-200 bg-ember-50/90 px-4 py-2 text-xs font-semibold uppercase tracking-[0.22em] text-ember-700 shadow-sm backdrop-blur dark:border-ember-500/20 dark:bg-ember-500/10 dark:text-ember-200">
            ...
            <div className="space-y-5">
              ...
              <p className="max-w-2xl text-base leading-8 text-text-sub-light dark:text-text-sub-dark sm:text-lg">
                CulinaryConnect turns hiring into a guided studio workflow: verified recruiter setup,
                portfolio-rich chef profiles, and a calmer application experience for both sides.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-3">
              {highlights.map((item, index) => (
                <motion.article
                  ...
                  className="executive-panel flex min-h-[170px] flex-col justify-between p-5"
                >
                  <div>
          ...
          <motion.section
            ...
            className="relative"
          >
            <div className="glass-panel relative overflow-hidden p-6 sm:p-7 lg:p-8">
              ...
              <div className="relative space-y-5">
                ...
                <div className="grid gap-4">
                  {pillars.map(({ icon: Icon, title, description }) => (
                    <article
                      key={title}
                      className="rounded-[1.6rem] border border-white/80 bg-white/88 p-5 shadow-sm dark:border-white/10 dark:bg-white/5"
                    >
