          ...
          <SurfaceCard className="p-5 sm:p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {missingItems.length > 0 ? (
                ...
                <StatusPill tone="success">Profile signal is strong</StatusPill>
              )}
            </div>
            <Button
            ...
            <div className="mt-5 grid gap-3">
              {appsLoading ? (
                ...
                activeApplications.slice(0, 4).map((application) => (
                  <button
                    className="flex items-center justify-between rounded-[1.35rem] border border-white/70 bg-white/75 p-4 text-left transition hover:-translate-y-0.5 hover:border-primary/20 hover:shadow-sm dark:border-white/10 dark:bg-white/5"
                  ...
                  >
                    ...
                    <StatusPill
                      tone={
                        application.status === "a" || application.status === "h"
                          ? "success"
