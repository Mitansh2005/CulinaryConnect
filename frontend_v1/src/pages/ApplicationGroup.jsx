      ...
      {totalPages > 1 && (
        <div className="mt-4 flex items-center justify-end gap-2">
          <button
            ...
            disabled={page === 0}
            className="flex h-9 w-9 items-center justify-center rounded-xl border border-white/70 bg-white/80 text-text-sub-light transition hover:border-primary/30 hover:text-primary disabled:cursor-not-allowed disabled:opacity-40 dark:border-white/10 dark:bg-white/5 dark:text-text-sub-dark"
          >
