...
import {
  JobCardSkeleton,
  StatCardSkeleton,
} from "@/components/ui/custom/skeletons/Skeletons";
    ...
    return (
      ...
      >
        <EmptyPanel
          ...
          description={
            hasError?.message ||
            "An unknown error occurred while fetching server data."
          }
              ...
              <div className="mt-5 grid gap-3">
                {recentApplicants.length === 0 ? (
                  ...
                  recentApplicants.map((application) => {
                    ...
                    return (
                      <button
                        className="cc-scroll-in flex flex-col gap-4 rounded-[1.5rem] border border-white/80 bg-white/90 p-4 text-left transition hover:-translate-y-0.5 hover:border-primary/20 hover:shadow-sm dark:border-white/10 dark:bg-white/10 sm:flex-row sm:items-center sm:justify-between"
                        key={appId}
              ...
              <div className="mt-5 grid gap-3">
                {topJobs.length === 0 ? (
                  ...
                  topJobs.map((job) => {
                    ...
                    return (
                      <div
                        className="cc-scroll-in flex flex-col gap-4 rounded-[1.5rem] border border-white/80 bg-white/90 p-5 dark:border-white/10 dark:bg-white/10 sm:flex-row sm:items-center sm:justify-between"
                        key={job.job_id}
                      >
                        <div>
                          ...
                          <p className="mt-2 text-sm text-text-sub-light dark:text-text-sub-dark">
                            {job.employment_type || "Full Time"} role at{" "}
                          ...
                          <div className="mt-3 flex flex-wrap gap-2">
                            ...
                            <StatusPill
                              tone={
                                job.status === "closed" ? "danger" : "success"
                              }
                            >
